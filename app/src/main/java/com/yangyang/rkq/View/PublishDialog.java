...
//这三个方法设置了三个控件的点击事件并返回一个PublishDialog 这里需要一个OnClickListener的参数
    ...
    public com.yangyang.rkq.View.PublishDialog setFabuClickListener(View.OnClickListener clickListener){
        mPublishDialogFabu.setOnClickListener(clickListener);
        return this;

    }
    public com.yangyang.rkq.View.PublishDialog setHuishouClickListener(View.OnClickListener clickListener){
        mPublishDialogHuishou.setOnClickListener(clickListener);
        return this;

    }
    public com.yangyang.rkq.View.PublishDialog setPingguClickListener(View.OnClickListener clickListener){
